...
#includ"gmath.h"//external_nmea
#include "info.h"//external_nmea
#include "nmeatime.h"
#include "qgsgpsmarker.h"
#include "qgsmaptoolcapture.h"//地图捕获工具
#include "qgspanelwidget.h"//GPS面板窗口
#include "qgsmapcanvasinteractionblocker.h"//地图交互
#include <qwt_plot_curve.h>					//应该是绘图
#ifdef WITH_QWTPOLAR
...
/**
 * A dock widget that displays information from a GPS device and停靠小部件，显示来自GPS设备的信息，
 * allows the user to capture features using gps readings to
 * specify the geometry.以及允许用户使用gps读数指定特征来捕获特征
 */
class APP_EXPORT QgsGpsInformationWidget: public QgsPanelWidget, public QgsMapCanvasInteractionBlocker, private Ui::QgsGpsInformationWidgetBase//继承了停靠面板，交互面板、GPS信息窗口
{
    Q_OBJECT
  public:
...
// not used    QPointF gpsToPixelPosition( const QgsPoint& point );
    ...
    QgsPointXY mLastGpsPosition;						//最新的GPS位置
